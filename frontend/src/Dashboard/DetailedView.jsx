        ...
        <div className="mt-8">
          ...
          >
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              in front-end and back-end technologies. He specializes in building
              scalable web applications with React, Node.js, and Tailwind CSS.
            </p>
            <img
          ...
          >
            ...
            <ul className="list-disc list-inside text-gray-700 leading-relaxed">
              <li>Developed scalable e-commerce platforms using MERN stack.</li>
              <li>
            ...
            <div className="space-y-4">
              <div className="bg-gray-100 p-4 rounded-lg">
                <p className="text-gray-700">
                  "John did an excellent job. The project was delivered on time
